...
Java_io_github_limuyang2_xxhash_lib_internal_XXHashNative_xxh32(JNIEnv *env, jclass cls,
...
JNIEXPORT jlong JNICALL
Java_io_github_limuyang2_xxhash_lib_internal_XXHashNative_xxh32Bytes(JNIEnv *env, jclass cls,
...
JNIEXPORT jlong JNICALL
Java_io_github_limuyang2_xxhash_lib_internal_XXHashNative_xxh64(JNIEnv *env, jclass cls,
...
JNIEXPORT jlong JNICALL
Java_io_github_limuyang2_xxhash_lib_internal_XXHashNative_xxh64Bytes(JNIEnv *env, jclass cls,
                                                       jbyteArray input, jint offset,
...
JNIEXPORT jlong JNICALL
Java_io_github_limuyang2_xxhash_lib_internal_XXHashNative_xxh3_164bits(JNIEnv *env, jclass cls,
                                                         jbyteArray input)
{
    (void)cls;
    jsize len = (*env)->GetArrayLength(env, input);
...
JNIEXPORT jlong JNICALL
Java_io_github_limuyang2_xxhash_lib_internal_XXHashNative_xxh3_164bitsWithSeed(JNIEnv *env, jclass cls,
                                                                 jbyteArray input, jlong seed)
{
    (void)cls;
    jsize len = (*env)->GetArrayLength(env, input);
...
Java_io_github_limuyang2_xxhash_lib_internal_XXHashNative_xxh3_1128bits(JNIEnv *env, jclass cls,
                                                          jbyteArray input)
{
    (void)cls;
    jsize len = (*env)->GetArrayLength(env, input);
...
JNIEXPORT jlongArray JNICALL
Java_io_github_limuyang2_xxhash_lib_internal_XXHashNative_xxh3_1128bitsWithSeed(JNIEnv *env, jclass cls,
                                                                  jbyteArray input, jlong seed)
{
    (void)cls;
    jsize len = (*env)->GetArrayLength(env, input);
