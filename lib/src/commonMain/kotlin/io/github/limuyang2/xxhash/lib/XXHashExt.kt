 ...
 */
fun String.xxh32(seed: Int = 0): Long = encodeToByteArray().xxh32(seed)

/**
 * XXH64 hash of this string (UTF-8 bytes).
 */
fun String.xxh64(seed: Long = 0): Long = encodeToByteArray().xxh64(seed)

/**
 * XXH3 64-bit hash of this string (UTF-8 bytes).
 */
fun String.xxh3As64(seed: Long = 0): Long = encodeToByteArray().xxh3As64(seed)

/**
 * XXH3 128-bit hash of this string (UTF-8 bytes).
 */
fun String.xxh3As128(seed: Long = 0): LongArray = encodeToByteArray().xxh3As128(seed)
